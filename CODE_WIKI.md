...
| [spec/defect-fixes/](./spec/defect-fixes/) | P-022 缺陷修复批方案（DESIGN v1.1 draft——gate auto-commit 缺陷三选项 A/B/C 推荐 A+B（门控默认关 + 精确 sid 范围 + git 根派生）+ DIS-008 并行 Edit 竞态第 4 次复发规则化；subagent 审查完成 = A+B 修正后采纳，待用户决策） |
