...
│   ├── PROGRESS.md                       # 待办登记（P-001~P-016 + P-009 全 done；主动队列清空，剩触发驱动项）
...
| [docs/PROGRESS.md](./docs/PROGRESS.md) | 待办登记：P-001~P-016 done + P-009 done（2026-08-27 实施批收口——Spec_Runner 仓落地 commit 4ea703d，runner 已可用；主动队列清空） |
