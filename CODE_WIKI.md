...
│   ├── PROGRESS.md                       # 待办登记（P-001~P-022 登记在册 22 项——P-001 至 P-021 全 done + P-022 缺陷修复批 in-progress，剩触发驱动项）
...
└── spec/
    ...
    ├── community-ecosystem/    # 社区同类框架生态调研（P-018 done：26A+3B+13C+4H，v1.6 吃狗粮审计轮——6P2+5P3 修正；v1.7 §3.5 首裁定已吸收 P-020 done，ARC 升优先候选待裁决）
    ...
    ├── defect-fixes/           # P-022 缺陷修复批（方案落档：gate auto-commit 门控+范围绑定 与 DIS-008 竞态规则化——DESIGN v1.0 draft 待 subagent 审查 + 用户决策）
...
| [docs/PROGRESS.md](./docs/PROGRESS.md) | 待办登记：P-001~P-022 在册 22 项（P-001 至 P-021 全 done + P-022 缺陷修复批 in-progress；主动队列清空，剩触发驱动项） |
...
| [spec/defect-fixes/](./spec/defect-fixes/) | P-022 缺陷修复批方案（DESIGN v1.0 draft——gate auto-commit 缺陷三选项 A/B/C 推荐 A+B（门控默认关 + 精确 sid 范围 + git 根派生）+ DIS-008 并行 Edit 竞态第 4 次复发规则化；auto-commit 待 subagent 审查 + 用户决策） |
