...
| [spec/community-ecosystem/](./spec/community-ecosystem/) | 社区同类框架生态调研（P-018 done：COMMUNITY_ECOSYSTEM_RESEARCH v1.0（16A+2B+7C+3H）——四簇盘点 + 分层吸收判定待用户裁决；立即候选 AGENTS.md 桥 / drift-gate 概念，候选 ARC 方向 A 先导 / DeepEval 臂） |
