...
│   ├── PROGRESS.md                       # 待办登记（P-001~P-025 登记在册 25 项——P-001 至 P-025 全 done，剩触发驱动项）
...
| [docs/PROGRESS.md](./docs/PROGRESS.md) | 待办登记：P-001~P-025 在册 25 项（P-001 至 P-025 全 done；主动队列清空，剩触发驱动项） |
