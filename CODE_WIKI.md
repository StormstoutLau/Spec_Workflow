...
│   ├── PROGRESS.md                       # 待办登记（P-001~P-016 done + P-009 in-progress 设计批；主动队列清空，P-009 已触发）
...
└── spec/
    ...
    └── spec-runner/            # Spec_Runner 薄壳 runner 设计批（P-009 in-progress：RESEARCH + DESIGN D1-D7，实施批待触发——独立仓库 F:\Spec_Runner）
```
...
| [docs/PROGRESS.md](./docs/PROGRESS.md) | 待办登记：P-001~P-016 done + P-009 in-progress（设计批 2026-08-26 完成，实施批待触发——独立仓库 F:\Spec_Runner） |
...
| [spec/spec-runner/](./spec/spec-runner/) | Spec_Runner 薄壳 runner（P-009 in-progress 设计批：RESEARCH v1.0（端点复核 E1 + LOC 拆解 B1）+ DESIGN v1.0（D1-D7：双仓结构/L1-L7 落地/gate 物理化/adapter 开放结构/零依赖）——实施批待触发，独立仓库 F:\Spec_Runner） |
