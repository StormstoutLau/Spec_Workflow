...
| [docs/PROGRESS.md](./docs/PROGRESS.md) | 待办登记：P-001~P-016 全 done（P-016 决策记录 schema 吸收 B 方案契约批 2026-08-26 独立 pass 通过收口，FWK-DECISION-RECORD v1.1；主动队列清空，P-009 触发驱动悬置） |
