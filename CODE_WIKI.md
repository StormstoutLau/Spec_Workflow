...
│   ├── PROGRESS.md                       # 待办登记（P-001~P-017 全 done；主动队列清空，剩触发驱动项）
...
| [docs/PROGRESS.md](./docs/PROGRESS.md) | 待办登记：P-001~P-017 done（P-017 于 2026-09-07 Spec_Runner 接入扩散收口——通用接入模板 + 具体接入示例；主动队列清空） |
