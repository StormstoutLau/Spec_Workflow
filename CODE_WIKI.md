...
| [spec/spec-runner-homing/](./spec/spec-runner-homing/) | Spec_Runner 归巢调研（P-019 in-progress：SPEC_RUNNER_HOMING_RESEARCH v1.0（5A+2B+3C+2H）——外部路径依赖面取证 = 零代码依赖（纯文档指针），三方案裁决 C1 维持双仓否决并入 / C2 懒加载分层采纳（工具层 RUNNER 探测）/ C3 P-019 编号撞号处理；实施批待用户裁决触发） |
